    ...
    ingredientArray.forEach((element, index) => {
      ingredientJSXList.push(
        <View  key={index} style = {{flexDirection: 'row', flex: 4, borderWidth:  1, marginTop: 5, marginBottom: 5, marginLeft: 20, marginRight: 20, padding: 5, alignItems: 'center', backgroundColor: '#062D4A', borderRadius: 7, borderColor: '#062D4A'}}>
          {/* Amount Input */}
          <TextInput
            style={{ height: 48, borderWidth:  1, marginTop: 8, marginBottom: 5, marginLeft: 10, marginRight: 20, padding: 10, textAlign: 'center', fontFamily: 'Orienta', borderRadius: 10, paddingTop: 14, color: '#545252', backgroundColor: '#D9D9D9'}}
            editable
          ...
          {/* Name Input */}
          <TextInput
            style={{ height: 48, borderWidth:  1, marginTop: 8, marginBottom: 5, marginLeft: 20, marginRight: 20, padding: 10, textAlign: 'center', fontFamily: 'Orienta', borderRadius: 10, paddingTop: 14, color: '#545252', backgroundColor: '#D9D9D9'}}
            editable
            multiline={true}
            numberOfLines={1}
            blurOnSubmit={true}
          ...
          <View style={styles.deleteIngredient} >
            <TouchableOpacity onPress={() => RemoveIngredent(index)} >
              <Text style={[{color: '#FFFFFF'}, {fontFamily: 'Orienta'}]}>Delete</Text>
            </TouchableOpacity>
          </View>
        </View>
      );
